...
class OrderRepositoryTest {
    ...
    public void beforeEach() {
        ...
        user1 = new User("user1", "user1", "user1", "01012345678", address, "USER", LocalDateTime.now());
        em.persist(user1);
        user2 = new User("user2", "user2", "user2", "01012345678", address, "USER", LocalDateTime.now());
        em.persist(user2);
